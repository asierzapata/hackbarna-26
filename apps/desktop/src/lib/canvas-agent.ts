...
const descriptions: Record<keyof typeof toolSchemas, string> = {
  addNode: "Create a native tldraw geo shape or a markdown, chart, table, image, map, logo, timeline, or calendar node on the current canvas. Use draft {type: \"geo\", geo: \"rectangle\", text: \"Label\", w: 240, h: 120} for a box, {type: \"geo\", geo: \"ellipse\", w: 160, h: 160} for a circle, or {type: \"logo\", domain: \"example.com\", name: \"Example\"} for a Brandfetch-backed company logo. Use unequal w and h for an oval. Use near to place related nodes beside an existing shape or overlap a logo with its sponsor box. Returns its shapeId.",
