...
import { createKanShapeUtils, LogoShapeUtil, MapShapeUtil, TableShapeUtil } from "@/nodes/shapes";
...
const syncShapeUtils = [...defaultShapeUtils, ...shapeUtils, MapShapeUtil, TableShapeUtil, LogoShapeUtil];
