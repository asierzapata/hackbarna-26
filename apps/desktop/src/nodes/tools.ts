import { createShapeId, toRichText, type TLArrowBinding, type TLArrowShape, type TLGeoShape, type TLShape, type TLShapeId, type TLShapePartial } from "@tldraw/tlschema";
